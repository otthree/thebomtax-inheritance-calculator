        ...
        {submitStatus === "success" ? (
          ...
          <div className="space-y-6">
            <div className="bg-slate-50 rounded-lg p-4">
              <h3 className="font-semibold mb-3">계산 결과 요약</h3>
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <span className="font-medium ml-2 text-blue-600">{formatNumber(calculationData.finalTax)}만원</span>
                </div>
              </div>
            </div>
            ...
            <div className="text-xs text-gray-500 bg-gray-50 p-3 rounded">
              ...
              <p>
                수집된 개인정보는 상담 목적으로만 사용되며, 상담 완료 후 안전하게 폐기됩니다. 자세한 내용은
                개인정보처리방침을 확인해주세요.
              </p>
            </div>
          </div>
