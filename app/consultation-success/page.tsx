...
export default function ConsultationSuccessPage() {
  ...
  return (
    <>
      <Head>
        <title>상담 신청 완료 | 세무법인 더봄</title>
        <meta name="description" content="상담 신청이 완료되었습니다. 전문 세무사가 곧 연락드릴 예정입니다." />
      </Head>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
            ...
            <CardContent className="text-center py-12 px-8">
              ...
              <div className="space-y-3">
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full border-blue-500 text-blue-600 hover:bg-blue-50 py-3 text-base font-medium"
                  size="lg"
                >
        ...
        <footer className="bg-slate-800 text-white py-6 mt-16">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <p className="text-sm">© 2025 세무법인 더봄. 전문적이고 신뢰할 수 있는 세무 서비스를 제공합니다.</p>
          </div>
        </footer>
      </div>
    </>
